...
import litoperez from '../../Components/Imagenes/litoperez.jfif'
...
function AcercadeCom() {
  ...
  return (
    <div className='container-historia'>
     ...
     <div>
      <h1>Hitoria y Pasión</h1>
      <p>El Puntarenas Fútbol Club (PFC) es un club de fútbol costarricense fundado en 2004, con sede en la ciudad de Puntarenas.
         Es el tercer equipo de la provincia del Pacífico en la Primera División, después del Municipal Puntarenas.
